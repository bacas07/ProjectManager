...
const contextJSONSchema = z.object({
    projectOverview: z.string().min(1, 'ProjectOverview context is required').max(1000),
    ...
    conversationSummary: z.string().min(1, 'ConversationSumary context is required').max(1500)
});
