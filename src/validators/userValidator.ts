...
export const userInputSchema = object({ // Puro sufrimiento pasar de zod a valibot :|
    username: pipe( // Implementar pipe para encapsular y transformar los datos
        string(),
        toLowerCase(),
        trim(),
    ...
    email: pipe( // Numero maximo es igual al maximo que se permite para crear un email
        string(),
        toLowerCase(),
        trim(),
    ...
    role: optional( // Optional para dolores de cabeza
        pipe(
            string(),
